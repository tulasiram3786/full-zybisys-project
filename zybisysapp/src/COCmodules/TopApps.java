...
public class TopApps {
	...
	/* Top Apps Received bandwidth Script
	 * 
	 * 	
	 */
		 ...
		 * 
		 */
				driver.get("https://dev.zybisys.com/coc/reports/top_apps");
				Thread.sleep(3000);
				/*
				 * Select from date and Time Script
				 * 
				 */
				...
				/*
				 * Select To date and Time Script
				 */
				...
				Thread.sleep(10000);
				/*
				 * Selecting Received in Apps
				 * 
				 */
				List<WebElement> receivedList = driver.findElements(By.xpath("//td[contains(@class,'MuiTableCell-root MuiTableCell-body')][4]"));
		...
		public static Float getTransmittedGbForIpAddress(WebDriver driver, String ip) throws InterruptedException {
		/*
		 *Click on Reports in COC Module
		 * 	
		 */
				...
				Thread.sleep(3000);
				/*
				 * Selecting From Date and Time Script
				 * 
				 * 
				 */
				String inputXpath = "//label[text()='From']/following::div[1]/input";
				...
				/*
				 * Selecting To Date and Time Script
				 * 
				 */
				inputXpath = "//label[text()='To']/following::div[1]/input";
				dateXpath  =         "(//input[@type='text']/following::span[text()='July, 2022']/following::button/following::table/tbody/tr/td[text()='27'])[4]";
				...
				Thread.sleep(10000);
				/*
				 * Selecting Transmitted in Apps
				 * 
				 */
				List<WebElement> transmittedList = driver.findElements(By.xpath("//td[contains(@class,'MuiTableCell-root MuiTableCell-body')][5]"));
				Float totalTransmitted = 0f;
				for(int i=1; i<transmittedList.size();i++) {
		...
		/*
		 * Top Apps Total bandwidth Script
		 * 	
		 * 
		 */
			/*
			...
			Thread.sleep(10000);
			/*
			 * Selecting Total in Apps
			 */
			List<WebElement> totalList = driver.findElements(By.xpath("//td[contains(@class,'MuiTableCell-root MuiTableCell-body')][6]"));
			Float totalMb = 0f;
		...
		/*
		 * Convertion of data(Gigabyte, KiloByte, Bytes, Bites) to MB Script
		 * 
		 */
