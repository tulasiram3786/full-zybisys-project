...
public class reporters {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(5000);
		driver.findElement(By.xpath("(//div[@class='calendar-days'])[1]")).sendKeys(Keys.ESCAPE);
		
		Select dropdown = new  Select(driver.findElement(By.xpath("//div[@class='MuiFormControl-root sc-iJCRrE bojiJp']")));
